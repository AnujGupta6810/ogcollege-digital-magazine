export const mockBlogs = [
  ...
  },
  {
    ...
    excerpt: "How social media has transformed the way students organize and advocate for change on campus.",
    category: "Culture",
    author: "Taylor Kim",
    date: "2 weeks ago",
    readTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "Understanding why we delay tasks and proven strategies to overcome academic procrastination.",
    category: "Education",
  ...
  },
  {
    ...
    excerpt: "Exploring the rise of student-run food co-ops and sustainable eating initiatives on college campuses.",
    category: "Life",
    author: "Jamie Park",
    date: "3 weeks ago",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt: "We break down the pros and cons of each path for aspiring developers.",
    category: "Technology",
    author: "Marcus Chen",
    date: "3 weeks ago",
    readTime: "9 min read",
  ...
  },
  {
    ...
    excerpt: "A comprehensive guide to campus and online mental health support systems.",
    category: "Opinion",
